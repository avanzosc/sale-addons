...
class SaleOrder(models.Model):
    ...
    different_amounts = fields.Boolean(
        ...
        compute="_compute_different_amounts",
        store=True,
        copy=False,
    )
    ...
    def _compute_different_amounts(self):
        for sale in self:
            ...
            if (
                sale.total_amount_from_import > 0
                and sale.amount_untaxed > 0
                and sale.total_amount_from_import != sale.amount_untaxed
            ):
