...
class TestSaleRequiredShippingAddress(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        vals = {"name": "Company 1", "company_type": "company"}
        cls.partner = cls.partner_model.create(vals)
        vals = {
            "name": "Company 1 shipping address 1",
            "company_type": "person",
            "type": "delivery",
        ...
        vals = {
            "name": "Company 1 shipping address 2",
            "company_type": "person",
            "type": "delivery",
            "parent_id": cls.partner.id,
        }
    ...
    def test_sale_required_shipping_address(self):
        ...
        result = sale._onchange_partner_id_warning()
        self.assertIn("warning", result)
        self.partner.write({"sale_warn": "warning", "sale_warn_msg": "bbbbbb"})
        result = sale._onchange_partner_id_warning()
